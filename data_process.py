...
class DataSampler:
    ...
    def create_hr_lr_pairs(self):
        ...
        for zoom in factors:
            ...
            lr = lr.resize(hr.size, resample=Image.BICUBIC)
            # lr.show()
...
# img = Image.open('Images/G0021_4.JPG')
# sampler = DataSampler(img, 2, 128)
# for x in sampler.generate_data():
#     a, b = x
#     print(a.size(), b.size())
#     hr = a[0].numpy().transpose((1, 2, 0))
#     lr = b[0].numpy().transpose((1, 2, 0))
